...
const { productsFromServiceSuccessful, productsFromModel, productsIDFromServiceSuccessful, productsFromServiceNotFound,
   productFromServiceCreated, createdProduct } = require('../mocks/products.mock');
